...
![](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/b0hu8q.jpg)
...
![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/jVzvEZ.jpg)
...
假设这里文本改一下，把 jikeshijian 变成 jikeshixi，正则 shijian 的 j 匹配不上时shixi 的 x，会接着使用正则 shixi 来进行匹配，重新从 s 开始（NFA引擎会记住这里）。
...
![](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/MR6Gi9.jpg)
...
![](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/Xw4YOI.jpg)

# 回溯

回溯是 NFA引擎才有的，并且只有在正则中出现量词或多选分支结构时，才可能会发生回溯。
...
![](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/VaUZPQ1659112406.jpg)
...
![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805537-2ab2e162-997b-48ec-8e46-2c092685ae151659112544MbbdxY.png)
...
![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805530-8c090f1e-2f62-461a-8e4b-b4bae6084ea31659112614cHdJ1b.png)



我们继续回溯，第二个分支匹配上的 t 吐出，第一个分支匹配上的 a 也吐出，再用第二个分支匹配 a 再试，如此发生了大量的回溯。你可以使用 regex101.com 中的 Regex Debugger 来调试一下这个过程，加深你的理解。

![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805513-0bd866a8-18e6-4caa-a81d-8cba1feca3641659112683015AGU.png)



![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805574-45fe1ceb-95b1-4fea-95ad-511136820f23-1659112761-vNi2ws.png)



我们来尝试优化一下，把第一个分支中的 A-Za-z 去掉，因为后面多选分支结构中重复了，我们再看一下正则尝试匹配的次数（[示例](https://regex101.com/r/Qbsm4g/2)），可以看到只尝试匹配了 57 次就结束了。

![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805571-d7a4e4d6-1149-47c2-889e-856330203d2b-1659112832-bJ9Fm2.png)
...
![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805528-23bc4ced-4994-484f-9cca-1b33f97a72b7-1659112891-j1nICB.png)
...
![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805615-53602a73-8e33-4a1b-a272-c159773cc959-1659112944-m08R8M.png)
...
![img](https://ced-md-picture.oss-cn-beijing.aliyuncs.com/uPic/1594195805552-fe52917e-7cd3-4216-805b-5f315cc3934b-1659113004-QfcQbH.png)
...
`^(?=[a-z])` 只能匹配上开头的空白符 [try](https://regex101.com/r/tWlm3A/1)

[11 | 如何理解正则的匹配原理以及优化原则？-极客时间](https://time.geekbang.org/column/article/258191)